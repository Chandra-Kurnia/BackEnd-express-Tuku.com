...
router
  ...
  .post("/", auth.authenticationAsSeller, createUpdateProductRules(), validateResult, upload.single("image"), ProductController.createProduct)
  ...
  .put("/:id", auth.authenticationAsSeller, createUpdateProductRules(), validateResult, upload.single("image"), ProductController.updateProduct)
